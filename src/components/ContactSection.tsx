        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Av. Luigi Rosiello, 204 - Parques Residencial Cidade Universitária - Ribeirão Preto - SP, 14051-090</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://www.tiktok.com/@rep12doses?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-background border border-border flex items-center justify-center hover:border-primary hover:text-primary transition-colors" aria-label="TikTok">
